...
describe('Navigating across the menu', () => {
	...
	it('should navigate across all menu items', () => {
		...
		cy.get('.sidenav-items>.simplebar-scroll-content>.simplebar-content').contains('bpp PBankRep').click()
		cy.location('pathname').should('include', 'queues/bankrep/70')
		cy.get('.sidenav-items>.simplebar-scroll-content>.simplebar-content').contains('Bank Rep Inventory').click()
